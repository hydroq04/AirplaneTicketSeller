  ...
  theme: {
    extend: {
      keyframes: {
        ...
        zoomOut: { '0%': { transform: 'scale(1)', opacity: '1' }, '100%': { transform: 'scale(0.9)', opacity: '0' }, },
        zoomOrigin: { '0%': { transform: 'scale(0.4)', opacity: '0' }, '100%': { transform: 'scale(1)', opacity: '1' }, },
        // Thêm mới
        slideIn: {
      ...
      animation: {
        ...
        // Thêm mới
        'slide-in-top': 'slideIn 0.4s ease-out forwards',
      },
